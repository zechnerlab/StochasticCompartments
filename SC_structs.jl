...
mutable struct TransitionClass
...
function pi_chemical_reaction!(yc::Vector{Vector{Int64}}, xc::Vector{Vector{Int64}}, change_vector::Vector{Int64})
    for d=1:length(yc[1])
...
function compute_moments(S::System, n::Matrix{Int64})
DD,Ncomp=size(n)
